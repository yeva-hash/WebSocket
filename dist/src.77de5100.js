...
},{"./url":"../node_modules/socket.io-client/build/url.js","./manager":"../node_modules/socket.io-client/build/manager.js","debug":"../node_modules/debug/src/browser.js","socket.io-parser":"../node_modules/socket.io-parser/dist/index.js","./socket":"../node_modules/socket.io-client/build/socket.js"}],"ElementsDOM.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.anonymBlock = exports.mainChatBlock = exports.messageInput = exports.sendMessageButton = exports.activeUsers = exports.mainBlock = exports.channelsBlock = exports.regisBlock = exports.nameInput = exports.regisButton = void 0; //Registration

exports.regisButton = document.querySelector(".registartion-button");
exports.nameInput = document.querySelector(".regis-input");
exports.regisBlock = document.querySelector(".modal-dialog-centered"); //Main Blocks

exports.channelsBlock = document.querySelector(".channel-container-none");
exports.mainBlock = document.querySelector(".container-none");
exports.activeUsers = document.querySelector("#active-users");
exports.sendMessageButton = document.getElementById("button-message");
exports.messageInput = document.getElementById("text-message");
exports.mainChatBlock = document.getElementById("main-chat");
exports.anonymBlock = document.getElementById("anonym-users-length");
...
exports.arrOfChannels = void 0;
exports.arrOfChannels = [];
...
var ElementsDOM_1 = require("./ElementsDOM");

var ElementsDOM_2 = require("./ElementsDOM");

var ElementsDOM_3 = require("./ElementsDOM");

var ElementsDOM_4 = require("./ElementsDOM");

var ElementsDOM_5 = require("./ElementsDOM");

var data_1 = require("./data");

var ElementsDOM_6 = require("./ElementsDOM");

var ElementsDOM_7 = require("./ElementsDOM");

var ElementsDOM_8 = require("./ElementsDOM");

var ElementsDOM_9 = require("./ElementsDOM");

var connectedUsers = {};
var connectedUsersForRoom = [];
var arrOfUsersId = [];
var arrOfUsersMessages = []; // const message = "dd"
// const obj = {
//     key: [{socketId:message},{socketId:message}]
// }
// console.log(obj)

var socket = socket_io_client_1.io("ws://bt-21-playground-vppfc.ondigitalocean.app/");
var leaveROOM_ID = "0";
ElementsDOM_1.regisButton === null || ElementsDOM_1.regisButton === void 0 ? void 0 : ElementsDOM_1.regisButton.addEventListener("click", registerUser);
ElementsDOM_7.sendMessageButton === null || ElementsDOM_7.sendMessageButton === void 0 ? void 0 : ElementsDOM_7.sendMessageButton.addEventListener("click", function () {
  var message = ElementsDOM_8.messageInput.value;
  var name = ElementsDOM_2.nameInput.value;
  socket.emit('msg_to_room', ElementsDOM_8.messageInput.value, leaveROOM_ID);
...
socket.on("connect", function () {
  // setAnonymUser() 
  socket.on("registration_completed", function () {});
  socket.on('join_success', function (roomId) {});
  socket.on('leave_success', function (roomId) {});
  socket.on("new_user_connected", function (socketId) {});
  socket.on("user_registered", function (username, socketId) {
    var user = {
      id: socketId,
      name: username
    };
  ...
  socket.on('new_message_to_room', function (message, roomId, userId) {
  ...
  socket.on('user_joined_room', function (socketId, roomId) {
    ElementsDOM_6.activeUsers.innerHTML = "";
    updateUserList(roomId);
  });
  socket.on('user_left_room', function (userId, roomId) {
...
function setMessageInLocaleStorage(roomId, userId, message) {}

function takeUserName(message, roomId, userId) {
  for (var _i = 0, _a = Object.entries(connectedUsers); _i < _a.length; _i++) {
    var _b = _a[_i],
        key = _b[0],
        value = _b[1];
...
function renderMessageContainer(name, message, roomId) {
  var userMessageContainer = document.createElement("div");
  userMessageContainer.classList.add("user-message-container");

  if (name === ElementsDOM_2.nameInput.value) {
    var userMessage = name + ": " + message + " (you)";
  ...
  ElementsDOM_9.mainChatBlock === null || ElementsDOM_9.mainChatBlock === void 0 ? void 0 : ElementsDOM_9.mainChatBlock.append(userMessageContainer);
}

function updateUserList(ROOM_ID) {
  socket.emit("get_users");
  socket.emit('get_users_for_room', ROOM_ID);
}

function addUsersToArr(users) {
  connectedUsers = {};
  connectedUsers = users; // setAnonymUser()
...
function addUsersToTheArrayOfRooms(users, ROOM_ID) {
  ...
  var _loop_1 = function _loop_1(key, value) {
    arrOfUsersId.forEach(function (userId) {
      if (key === userId) {
        var user = {
          id: key,
          name: value
  ...
  for (var _a = 0, _b = Object.entries(connectedUsers); _a < _b.length; _a++) {
    var _c = _b[_a],
        key = _c[0],
        value = _c[1];
  ...
  renderActiveUser(ElementsDOM_2.nameInput.value);
}

function renderActiveUsersForRoom(connectedUsersForRoom) {
  for (var i = 0; i < connectedUsersForRoom.length; i++) {
    if (connectedUsersForRoom[i].name === ElementsDOM_2.nameInput.value) continue;else renderActiveUser(connectedUsersForRoom[i].name);
  }
}

function renderActiveUser(activeUserName) {
  var activeUserContainer = document.createElement("p");
  activeUserContainer.classList.add("user");
  ElementsDOM_6.activeUsers === null || ElementsDOM_6.activeUsers === void 0 ? void 0 : ElementsDOM_6.activeUsers.append(activeUserContainer);
  activeUserContainer.textContent = activeUserName;

  if (activeUserName === ElementsDOM_2.nameInput.value) {
...
function registerUser() {
  socket.emit("get_users");
  var nameInputValue = ElementsDOM_2.nameInput.value;
...
function getChannels() {
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_a) {
      fetch('https://bt-21-playground-vppfc.ondigitalocean.app/rooms').then(function (response) {
        return response.json();
      }).then(function (data) {
        for (var i = 0; i < data.length; i++) {
          data_1.arrOfChannels.push(data[i]);
        }
      });
      return [2
      /*return*/
...
function renderChannelsList(arrOfChannels) {
...
function renderChannel(channel) {
  var channelContainer = document.createElement("p");
  channelContainer.classList.add("channel");
  channelContainer.textContent = channel.title;
  channelContainer.dataset.id = channel.id;
  ElementsDOM_4.channelsBlock === null || ElementsDOM_4.channelsBlock === void 0 ? void 0 : ElementsDOM_4.channelsBlock.append(channelContainer);
}

function renderDOM() {
  ElementsDOM_3.regisBlock === null || ElementsDOM_3.regisBlock === void 0 ? void 0 : ElementsDOM_3.regisBlock.remove();
  ElementsDOM_4.channelsBlock === null || ElementsDOM_4.channelsBlock === void 0 ? void 0 : ElementsDOM_4.channelsBlock.classList.remove("channel-container-none");
  ElementsDOM_4.channelsBlock === null || ElementsDOM_4.channelsBlock === void 0 ? void 0 : ElementsDOM_4.channelsBlock.classList.add("channel-container");
  renderChannelsList(data_1.arrOfChannels);
}

function joinChannel() {
  ElementsDOM_4.channelsBlock === null || ElementsDOM_4.channelsBlock === void 0 ? void 0 : ElementsDOM_4.channelsBlock.addEventListener('click', function (event) {
    ElementsDOM_6.activeUsers.innerHTML = "";
    ElementsDOM_9.mainChatBlock.innerHTML = "";

    if (event.target.classList.contains("channel")) {
      var ROOM_ID = event.target.dataset.id;
...
function renderMainBlock(ROOM_ID) {
  ElementsDOM_5.mainBlock === null || ElementsDOM_5.mainBlock === void 0 ? void 0 : ElementsDOM_5.mainBlock.classList.remove("container-none");
  ElementsDOM_5.mainBlock === null || ElementsDOM_5.mainBlock === void 0 ? void 0 : ElementsDOM_5.mainBlock.classList.add("container");
  socket.emit('get_users_for_room', ROOM_ID);
}
...
joinChannel(); // 
//
},{"socket.io-client":"../node_modules/socket.io-client/build/index.js","./ElementsDOM":"ElementsDOM.ts","./data":"data.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
